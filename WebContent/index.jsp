...
if(request.getParameter("btn")!=null)
{
	...
	db.execute("Insert into Feedback (Name,Phone,Email,Message) values(?,?,?,?)", name,mobileno,email,body);
	    ...
	    <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
					...
					<div class="col-sm-5">
						<div class="shoes_img"><img src="/footware/images/running-shoes.png"></div>
					</div>
				</div>
                </div>
    	    	...
    	    	<div class="row">
    	    		<div class="col-md-6">
    	    			<div class="about-img">
    	    				...
    	    				<div class="star_icon">
    	    					<ul>
    	    						<li><a href="#"><img src="/footware/images/star-icon.png"></a></li>
    	    						<li><a href="#"><img src="/footware/images/star-icon.png"></a></li>
    	    						<li><a href="#"><img src="/footware/images/star-icon.png"></a></li>
    	    						<li><a href="#"><img src="/footware/images/star-icon.png"></a></li>
    	    						<li><a href="#"><img src="/footware/images/star-icon.png"></a></li>
    	    		...
    	    		<div class="col-md-6">
    	    			<div class="about-img2">
    	    				<div class="shoes-img2"><img src="/footware/images/shoes-img2.png"></div>
    	    				<p class="sport_text">Men Sports</p>
    	    				<div class="dolar_text">$<strong style="color: #f12a47;">90</strong> </div>
    	    				<div class="star_icon">
    	    					<ul>
    ...
    <div class="collectipn_section_3 layuot_padding">
    	<div class="container">
    		<div class="racing_shoes">
    			<div class="row">
    				<div class="col-md-8">
    					<div class="shoes-img3"><img src="/footware/images/shoes-img3.png"></div>
    				</div>
    				<div class="col-md-4">
    		...
    		<div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					...
    					<div class="shoes_icon"><img src="/footware/images/shoes-img4.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Best Shoes </p>
    					<div class="shoes_icon"><img src="/footware/images/shoes-img5.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="images/star-icon.png"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Best Shoes </p>
    					<div class="shoes_icon"><img src="/footware/images/shoes-img6.png"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="/footware/images/star-icon.png"></a></li>
